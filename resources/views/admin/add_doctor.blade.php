                    ...
                    <div class="col-md-8">
                        ...
                        <form action="{{url("add-doctor")}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control text-black" id="doctor" name="doctor_name">
                            </div>

                            <div class="mb-3">
                                <label for="phone" class="form-label">Phone</label>
                                <input type="text" class="form-control text-black" id="phone" name="phone">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control text-black" id="room" name="room">
                            </div>

                            <div class="mb-3">
                                <label for="image" class="form-label">Doctor Image</label>
                                <input type="file" class="form-control" type="file" id="image" name="image">
                            </div>
